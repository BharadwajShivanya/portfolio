import { a as React, j as jsxRuntimeExports, m as motion, r as reactExports } from "./index-jWeVi0VY.js";
import { c as useSubmitContact } from "./useBackend-B0-FJsEj.js";
...
function ContactPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { "data-ocid": "contact.page", className: "min-h-screen", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-card border-b border-border py-20 px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-2xl mx-auto text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(RevealSection, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-body tracking-[0.18em] uppercase text-muted-foreground mb-4", children: "Get in Touch" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-4xl md:text-5xl text-foreground leading-tight mb-6", children: "Contact Dr. Sharma" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-px bg-accent mx-auto mb-6" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-muted-foreground text-base leading-relaxed", children: "For academic inquiries, collaboration proposals, lecture invitations, or research correspondence, please reach out directly." })
    ] }) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-background py-16 px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-5 gap-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-2 space-y-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(RevealSection, { delay: 0.1, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-xl text-foreground mb-4", children: "Academic Contact" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-px bg-accent mb-6" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(RevealSection, { delay: 0.2, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-muted/40 border border-border rounded-lg p-5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-sm text-muted-foreground leading-relaxed italic", children: '"I welcome correspondence from scholars, students, and practitioners engaged with questions of development economics, institutional reform, and the history of economic thought."' }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-sm text-foreground mt-3", children: "— Dr. I.C. Sharma" })
        ] }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:col-span-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(RevealSection, { delay: 0.15, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-card border border-border rounded-xl p-8 shadow-sm", children: submitContact.isSuccess ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-14 h-14 rounded-full bg-primary/10 flex items-center justify-center mx-auto mb-5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "svg",
              {
                width: "24",
                height: "24",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-xl text-foreground mb-2", children: "Message Received" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-muted-foreground text-sm leading-relaxed", children: "Thank you for your inquiry. Dr. Sharma will respond within 3–5 working days." })
          ]
        }
      ) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-sm text-muted-foreground mb-6 leading-relaxed", children: "For academic or professional inquiries, please complete the form below. All fields are required. Please allow 3–5 working days for a response." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "form",
          {
            ...
            children: [
              ...
              submitContact.isError && /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
...
function ContactDetail({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-xs uppercase tracking-[0.1em] text-muted-foreground mb-0.5", children: label }),
    ...
    ) : /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-sm text-foreground", children: value })
  ] });
}
export {
